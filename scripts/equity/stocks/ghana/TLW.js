...
const scrapeTLWGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-tlw/', {
    ...
    console.error('Error scraping Tullow Oil Plc:', error);

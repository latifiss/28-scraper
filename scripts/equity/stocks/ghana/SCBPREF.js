...
const scrapeSCBPrefGhana = async () => {
  let browser;
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-scbpf/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Standard Chartered Bank Ghana Limited Preference Shares (SCBPF.gh)';
    ...
    console.error(
      'Error scraping Standard Chartered Bank Preference Shares:',
      error,
    );
...
module.exports = { scrapeSCBPrefGhana };

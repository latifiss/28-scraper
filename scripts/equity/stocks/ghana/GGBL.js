...
const scrapeGGBLGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-ggbl/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Guinness Ghana Breweries Limited (GGBL.gh)';
    ...
    console.error('Error scraping Guinness Ghana Breweries Limited:', error);
...
module.exports = { scrapeGGBLGhana };

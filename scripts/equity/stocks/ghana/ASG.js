...
const scrapeASGGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-asg/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Asante Gold Corporation (ASG.gh)';
    ...
    console.error('Error scraping Asante Gold Corporation:', error);

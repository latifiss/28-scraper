...
const scrapeTOTALGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-total/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Total Petroleum Ghana Limited (TOTAL.gh)';
    ...
    console.error('Error scraping Total Petroleum Ghana Limited:', error);
...
module.exports = { scrapeTOTALGhana };

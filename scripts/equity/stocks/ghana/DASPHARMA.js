...
const scrapeDASLPharmaGhana = async () => {
  let browser;
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-dasl/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Dannex Ayrton Starwin Limited (DASL.gh)';
    ...
    console.error('Error scraping Dannex Ayrton Starwin Limited:', error);
...
module.exports = { scrapeDASLPharmaGhana };

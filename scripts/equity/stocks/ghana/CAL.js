...
const scrapeCALGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-cal/', {
    ...
    console.error('Error scraping CAL Bank Limited:', error);

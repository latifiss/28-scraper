...
const scrapeFMLGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-fml/', {
    ...
    console.error('Error scraping Fan Milk Limited:', error);

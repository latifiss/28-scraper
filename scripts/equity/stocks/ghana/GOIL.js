...
const scrapeGOILGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-goil/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Ghana Oil Company Limited (GOIL.gh)';
    ...
    console.error('Error scraping Ghana Oil Company:', error);
...
module.exports = { scrapeGOILGhana };

...
const scrapeEGLGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-egl/', {
    ...
    console.error('Error scraping Enterprise Group Limited:', error);

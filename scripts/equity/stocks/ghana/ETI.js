...
const scrapeETIGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-eti/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Ecobank Transnational Incorporation (ETI.gh)';
    ...
    console.error('Error scraping Ecobank Transnational Incorporation:', error);

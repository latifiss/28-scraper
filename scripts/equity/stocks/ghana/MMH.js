...
const scrapeMMHGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-mmh/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Meridian Marshall Holdings (MMH.gh)';
    ...
    console.error('Error scraping Meridian Marshall Holdings:', error);

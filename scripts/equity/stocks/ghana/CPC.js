...
const scrapeCPCGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-cpc/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Cocoa Processing Company (CPC.gh)';
    ...
    console.error('Error scraping Cocoa Processing Company:', error);

...
const scrapeSICGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-sic/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'SIC Insurance Company Limited (SIC.gh)';
    ...
    console.error('Error scraping SIC Insurance Company:', error);

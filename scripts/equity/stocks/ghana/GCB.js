...
const scrapeGCBGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-gcb/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Ghana Commercial Bank Limited (GCB.gh)';
    ...
    console.error('Error scraping Ghana Commercial Bank:', error);

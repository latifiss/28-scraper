...
const scrapeAADGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-aad/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'AngloGold Ashanti Depository Shares (AAD.gh)';
    ...
    console.error('Error scraping AngloGold Ashanti Depository Shares:', error);

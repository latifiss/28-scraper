...
const scrapeMTNGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-mtn/', {
    ...
    console.error('Error scraping MTN Ghana:', error);

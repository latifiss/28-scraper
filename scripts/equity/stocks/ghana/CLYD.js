...
const scrapeCLYDGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-clyd/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Clydestone (Ghana) Limited (CLYD.gh)';
    ...
    console.error('Error scraping Clydestone (Ghana) Limited:', error);
...
module.exports = { scrapeCLYDGhana };

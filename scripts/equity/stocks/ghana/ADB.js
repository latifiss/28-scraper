...
const scrapeADBGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-adb/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Agricultural Development Bank (ADB.gh)';
    ...
    console.error('Error scraping Agricultural Development Bank:', error);

...
const scrapeAGAGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-aga/', {
    ...
    console.error('Error scraping AngloGold Ashanti Limited:', error);

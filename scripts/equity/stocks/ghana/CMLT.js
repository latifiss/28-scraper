...
const scrapeCMLTGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-cmlt/', {
    ...
    console.error('Error scraping Camelot Ghana Limited:', error);
...
module.exports = { scrapeCMLTGhana };

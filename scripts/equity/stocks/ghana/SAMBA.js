...
const scrapeSAMBAFoods = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-samba/', {
    ...
    console.error('Error scraping Samba Foods Limited:', error);
...
module.exports = { scrapeSAMBAFoods };

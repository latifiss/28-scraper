...
const scrapeRBGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-rbgh/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Republic Bank (Ghana) Limited (RBGH.gh)';
    ...
    console.error('Error scraping Republic Bank (Ghana) Limited:', error);

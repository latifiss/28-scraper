...
const scrapeTBLGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-tbl/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Trust Bank Limited (The Gambia) (TBL.gh)';
    ...
    console.error('Error scraping Trust Bank Limited:', error);

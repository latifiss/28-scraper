...
const scrapeSCBGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-scb/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Standard Chartered Bank Ghana PLC (SCB.gh)';
    ...
    console.error('Error scraping Standard Chartered Bank Ghana:', error);

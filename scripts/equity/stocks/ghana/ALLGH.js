...
const scrapeALLGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-allgh/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Atlantic Lithium Limited (ALLGH.gh)';
    ...
    console.error('Error scraping Atlantic Lithium Limited:', error);

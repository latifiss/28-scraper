...
const scrapeMACGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-mac/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Mega African Capital Limited (MAC.gh)';
    ...
    console.error('Error scraping Mega African Capital Limited:', error);

...
const scrapeGLDGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-gld/', {
    ...
    console.error('Error scraping NewGold Issuer Limited:', error);

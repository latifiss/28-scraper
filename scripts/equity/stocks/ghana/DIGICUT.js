...
const scrapeDIGICUTGhana = async () => {
  let browser;
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-digict/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Digicut Advertising and Production Limited (DIGICT.gh)';
    ...
    console.error(
      'Error scraping Digicut Advertising and Production Limited:',
      error,
    );
...
module.exports = { scrapeDIGICUTGhana };

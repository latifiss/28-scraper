...
const scrapeACCESSGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-access/', {
    ...
    console.error('Error scraping Access Bank Ghana:', error);
...
module.exports = { scrapeACCESSGhana };

...
const scrapeUNILGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-unil/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Unilever Ghana Limited (UNIL.gh)';
    ...
    console.error('Error scraping Unilever Ghana Limited:', error);
...
module.exports = { scrapeUNILGhana };

...
const scrapeHORDSGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-hords/', {
    ...
    console.error('Error scraping Hords Limited:', error);
...
module.exports = { scrapeHORDSGhana };

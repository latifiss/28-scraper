...
const scrapeBOPPGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-bopp/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Benso Oil Palm Plantation Limited (BOPP.gh)';
    ...
    console.error('Error scraping Benso Oil Palm Plantation Limited:', error);
...
module.exports = { scrapeBOPPGhana };

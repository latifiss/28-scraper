...
const scrapeEBGGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-ebg/', {
    ...
    console.error('Error scraping Ecobank Ghana Limited:', error);

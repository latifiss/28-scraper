...
const scrapeSOGEGHGhana = async () => {
  ...
  try {
    ...
    await page.goto('https://africanfinancials.com/company/gh-sogegh/', {
    ...
    const companyData = await page.evaluate(() => {
      ...
      const companyName = companyNameEl
        ...
        : 'Societe Generale Ghana Limited (SOGEGH.gh)';
    ...
    console.error('Error scraping Societe Generale Ghana Limited:', error);
...
module.exports = { scrapeSOGEGHGhana };
